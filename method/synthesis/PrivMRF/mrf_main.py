...
import method.synthesis.PrivMRF.PrivMRF.utils.tools as tools
from method.synthesis.PrivMRF.PrivMRF.domain import Domain
from method.synthesis.PrivMRF.PrivMRF.main import run
import numpy as np
