...
import os 
import numpy as np
import method.synthesis.AIM.mbi.callbacks as callbacks
from method.synthesis.AIM.mbi.Domain import *
from method.synthesis.AIM.mbi.graphical_model import *
from method.synthesis.AIM.mbi.clique_vector import *
...
class FactoredInference:
    def __init__(
        ...
        if backend == "torch":
            from method.synthesis.AIM.mbi.torch_factor import Factor
